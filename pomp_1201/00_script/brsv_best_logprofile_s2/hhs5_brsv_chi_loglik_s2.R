...
## from estimation
load("res_hhs5_brsv_chi.rds")

best_past_est<-c(R01=past_est(res_hhs5_brsv_chi)$R01,
                          R02=past_est(res_hhs5_brsv_chi)$R02,
                          amplitude1=past_est(res_hhs5_brsv_chi)$amplitude1,
                          amplitude2 =past_est(res_hhs5_brsv_chi)$amplitude2,
                          tpeak1=past_est(res_hhs5_brsv_chi)$tpeak1,
                          tpeak2=past_est(res_hhs5_brsv_chi)$tpeak2,
                          rho1=past_est(res_hhs5_brsv_chi)$rho1,
                          rho2=past_est(res_hhs5_brsv_chi)$rho2)
