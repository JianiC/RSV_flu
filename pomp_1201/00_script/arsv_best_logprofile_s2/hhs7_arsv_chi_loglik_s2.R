...
best_past_est<-c(R01=past_est(res_hhs7_arsv_coinfect)$R01,
                          R02=past_est(res_hhs7_arsv_coinfect)$R02,
                          amplitude1=past_est(res_hhs7_arsv_coinfect)$amplitude1,
                          amplitude2 =past_est(res_hhs7_arsv_coinfect)$amplitude2,
                          tpeak1=past_est(res_hhs7_arsv_coinfect)$tpeak1,
                          tpeak2=past_est(res_hhs7_arsv_coinfect)$tpeak2,
                          rho1=past_est(res_hhs7_arsv_coinfect)$rho1,
                          rho2=past_est(res_hhs7_arsv_coinfect)$rho2,
                          psi=past_est(res_hhs7_arsv_coinfect)$psi)
