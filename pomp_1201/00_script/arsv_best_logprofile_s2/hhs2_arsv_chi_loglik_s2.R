...
## from estimation
load("./res_hhs2_arsv_chi.rds")

best_past_est<-c(R01=past_est(res_hhs2_arsv_chi)$R01,
                          R02=past_est(res_hhs2_arsv_chi)$R02,
                          amplitude1=past_est(res_hhs2_arsv_chi)$amplitude1,
                          amplitude2 =past_est(res_hhs2_arsv_chi)$amplitude2,
                          tpeak1=past_est(res_hhs2_arsv_chi)$tpeak1,
                          tpeak2=past_est(res_hhs2_arsv_chi)$tpeak2,
                          rho1=past_est(res_hhs2_arsv_chi)$rho1,
                          rho2=past_est(res_hhs2_arsv_chi)$rho2)
                          
chi_mle<-past_est(res_hhs2_arsv_chi)$chi
...
write.csv(res_hhs2_arsv_chi,"res_hhs2_arsv_chi_loglik_s2.csv",row.names=FALSE)
