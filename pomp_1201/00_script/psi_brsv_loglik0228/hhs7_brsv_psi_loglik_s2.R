...
best_past_est<-c(R01=past_est(res_hhs7_brsv_coinfect)$R01,
                          ...
                          chi=past_est(res_hhs7_brsv_coinfect)$chi) 
...
for (i in 1:length(psi_vals)){
  ...
  res_hhs7_brsv_psi_tmp <- data.frame (HHS_region =7,
                                       pathogen2 = "fluB",
                                       psi=psi_vals[i],
                                       loglik=-res_hhs7_brsv_psi_tmp$DEobj$optim$bestval)
  res_hhs7_brsv_psi <-rbind(res_hhs7_brsv_psi,res_hhs7_brsv_psi_tmp)
  
}

write.csv(res_hhs7_brsv_psi,"res_hhs7_brsv_psi_loglik_s2.csv",row.names=FALSE)
