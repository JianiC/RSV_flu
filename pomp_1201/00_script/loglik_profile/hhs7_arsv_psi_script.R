...
load("./res_hhs7_arsv_coinfect.Rdata")
best_past_est<-data.frame(past_est(res_hhs7_arsv_coinfect)$R01,
                          ...
                          past_est(res_hhs7_arsv_coinfect)$psi)
...
if(res_hhs7_arsv_psi$total2 == "fluA") message("Code itegration complete!")

save(res_hhs7_arsv_psi, file = "./res_hhs7_arsv_psi.Rdata")
