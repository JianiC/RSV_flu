...
traj_fit_arsv_bestmodel%>%
  ...
  xlab("Time")+
  ylab("Cases")+
  scale_color_manual(name="",values = c("Within sample"="#1B9E77","Out of sample"="#D95F02","Observed"="black"))->fluA_besfit
...
traj_fit_arsv_bestmodel%>%
  ...
  xlab("Time")+
  ylab("Cases")+
  scale_color_manual(name="",values = c("Within sample"="#1B9E77","Out of sample"="#D95F02","Observed"="black"))->fluA_besfit_repre
...
traj_fit_brsv_bestmodel%>%
  ...
  xlab("Time")+
  ylab("Cases")+
  scale_color_manual(name="",values = c("Within sample"="#1B9E77","Out of sample"="#D95F02","Observed"="black"))->fluB_besfit
...
traj_fit_brsv_bestmodel%>%
  ...
  xlab("Time")+
  ylab("Cases")+
  scale_color_manual(name="",values = c("Within sample"="#1B9E77","Out of sample"="#D95F02","Observed"="black"))->fluB_besfit_repre

library(ggpubr)
ggarrange(
  fluA_besfit, fluB_besfit, labels = c("A", "B"),
  nrow=1,
  common.legend = TRUE)->p_bestfit

ggarrange(
  fluA_besfit_repre, fluB_besfit_repre, labels = c("A", "B"),
  nrow=2,
  common.legend = TRUE)->p_bestfit_repre
