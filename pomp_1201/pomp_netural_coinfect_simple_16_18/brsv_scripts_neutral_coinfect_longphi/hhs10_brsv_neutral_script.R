...
if(res_hhs10_brsv_neutral$total2 == "fluB") message("Code itegration complete!")

save(res_hhs10_brsv_neutral, file = "../testb_result_neutral/res_hhs10_brsv_neutral.rds")
