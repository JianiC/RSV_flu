...
# loading parameter constraints 
 ...
 # regular parameters for the full model
  ...
  rp_vals_def <- c(R01 = 1, gamma1=365./9, w1=2,
               ...
               phi1=365/180, phi2=365/180, chi=1,
...
# loading parameter constraints
best_past_est<-data.frame(R01=1.81,
                          R02=1.12,
                          amplitude1=0.137,
                          amplitude2=0.228,
					      hypo_name = "co_infect",
...
save(res_hhs2_brsv_coinfect, file = "../testb_result_coinfect/res_hhs2_brsv_coinfect.Rdata")
