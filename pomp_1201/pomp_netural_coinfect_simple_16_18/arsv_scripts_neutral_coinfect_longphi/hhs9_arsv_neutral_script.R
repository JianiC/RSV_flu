...
if(FALSE) {
  ...
  pseudo_data <- tibble(time = seq(0, 10, by = 1/52), 
                        total1 = NA, 
                        total2 = NA, N = pomp_data_hhs9_arsv$N[1])
...
if(res_hhs9_arsv_neutral$total2 == "fluA") message("Code itegration complete!")

save(res_hhs9_arsv_neutral, file = "../test_result_neutral/res_hhs9_arsv_neutral.rds")
