...
if(res_hhs8_arsv_neutral$total2 == "fluA") message("Code itegration complete!")

save(res_hhs8_arsv_neutral, file = "../test_result_neutral/res_hhs8_arsv_neutral.rds")
