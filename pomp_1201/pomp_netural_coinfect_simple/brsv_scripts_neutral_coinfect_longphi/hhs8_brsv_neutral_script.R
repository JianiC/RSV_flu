...
if(FALSE) {
  ...
  pseudo_data <- tibble(time = seq(0, 10, by = 1/52), 
                        total1 = NA, 
                        total2 = NA, N = pomp_data_hhs8_brsv$N[1])
...
if(res_hhs8_brsv_neutral$total2 == "fluB") message("Code itegration complete!")

save(res_hhs8_brsv_neutral, file = "../testb_result_neutral/res_hhs8_brsv_neutral.rds")
