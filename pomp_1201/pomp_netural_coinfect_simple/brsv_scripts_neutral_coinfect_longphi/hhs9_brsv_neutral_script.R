...
if(res_hhs9_brsv_neutral$total2 == "fluB") message("Code itegration complete!")

save(res_hhs9_brsv_neutral, file = "../testb_result_neutral/res_hhs9_brsv_neutral.rds")
