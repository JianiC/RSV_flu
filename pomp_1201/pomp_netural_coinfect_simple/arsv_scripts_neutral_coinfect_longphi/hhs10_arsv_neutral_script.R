...
if(res_hhs10_arsv_neutral$total2 == "fluA") message("Code itegration complete!")

save(res_hhs10_arsv_neutral, file = "../test_result_neutral/res_hhs10_arsv_neutral.rds")
